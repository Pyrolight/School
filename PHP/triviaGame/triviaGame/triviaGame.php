...
if (isset($_SESSION['triviaArray'])) {
    ...
    // Used to deal with session errors when using the browsers refresh option.
    if ($_SESSION['gameCompleted'] == false) {
        ...
        if (!empty($_POST['guess'])) {
            ...
            // that an empty response was not due to the user changing the page style.    
...
if (!isset($_SESSION['triviaArray'])) {
    ...
    for ($i = 0; $i < sizeof($questions); $i++) {
        ...
        // Separate the question from the answer into separate positions in the array.
    ...
    // Add the initial variables to the session.
    ...
    <body>
        <div style="text-align: right;">
            <form id ="colourChange" action="triviaGame.php" method="POST">
                ...
                <label class="inline">Background Colour</label><select name="backgroundColour">
                    ...
                    <option value="orange" <?php echo ($styleChange[1] == "orange" ? "selected" : ""); ?>>Orange</option>                                   
                </select>
        ...
        <div id="box">
            <div id="verticalAlign">
                ...
                if ($questionPositionInArray == $arraySize) {
                    // Used to deal with some errors clicking the browsers refresh button.
